...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, arg):
        ...
        elif "{}.{}".format(varg[0], varg[1]) not in objdict:
            print("** no instance found **")
        else:
            print(objdict["{}.{}".format(varg[0], varg[1])])
    ...
    def do_destroy(self, arg):
        ...
        if len(varg) == 0:
            ...
            print("** instance id missing **")
        elif "{}.{}".format(varg[0], varg[1]) not in objdict.keys():
            print("** no instance found **")
        else:
            del objdict["{}.{}".format(varg[0], varg[1])]
            storage.save()
